      ...
      <div className="flex flex-col items-center gap-3">
        <div className="relative flex w-32 items-center justify-center">
          <div className="absolute left-0 -rotate-30 rounded-full bg-muted p-4">
            <Volume2 className="size-5 text-shadow-muted-foreground" />
          </div>
          ...
          <div className="absolute right-0 -rotate-30 rounded-full bg-muted p-4">
            <AudioLines className="size-5 text-shadow-muted-foreground" />
          </div>
        </div>
        ...
        <Button variant="outline" size="sm" asChild>
          <Link href={"mailto:nnoupingnouping@gmail.com"}>
            <BookOpen />
            Don&apos;t know how?
          </Link>
        </Button>
