        ...
        <form.Field name="text">
          {(field) => (
            <Textarea
              ...
              className="absolute inset-0 resize-none border-0 bg-transparent p-4 pb-4 lg:p-6 lg:pb-8 text-base! leading-relaxed tracking-tight shadow-none wrap-break-word focus-visible:ring-0"
