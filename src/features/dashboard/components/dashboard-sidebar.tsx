...
export function DashboardSidebar() {
  ...
  const otherMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      url: "mailto:nnoupingnouping@gmail.com",
      icon: Headphones,
    },
  ];
    ...
    <Sidebar collapsible="icon">
      <SidebarHeader className="flex flex-col gap-4 pt-4">
        <div className="flex items-center gap-2 pl-1 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:pl-0">
          ...
          />
          <span className="group-data-[collapsible=icon]:hidden font-semibold test-lg tracking-tighter text-foreground">
            Resonance
          </span>
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <OrganizationSwitcher
              hidePersonal
              fallback={
                <Skeleton className="h-8.5 w-full group-date-[collapsible=icon]:size-8 rounded-md border bg-white" />
              }
              appearance={{
                elements: {
                  rootBox:
          ...
          appearance={{
            elements: {
              ...
              userButtonOuterIdentifier:
                "text-[13px]! tracking-tight! fond-medium! text-foreground! pl-0! group-data-[collapsible=icon]:hidden!",
